        ...
        <div className="glass-elevated p-8 rounded-4xl surface-border border flex flex-col gap-6">
          <div className="text-center">
            ...
            <p className="text-on-surface-variant text-sm mt-2">
              Masuk ke akun iBacks Anda untuk pengalaman editorial berbelanja
              yang personal.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div className="text-right">
              <span className="text-primary text-xs hover:text-white cursor-pointer font-medium transition-colors">
                Lupa Password?
              </span>
            </div>
