    ...
    return (
      <div className="min-h-screen bg-background">
        ...
        <div className="flex flex-col items-center justify-center pt-32 px-4 text-center">
          ...
          <p className="text-on-surface-variant mb-8 max-w-sm">Temukan produk teknologi pelindung inovatif dari iBacks untuk gadget Anda.</p>
          <Link href="/search">
    ...
    <div className="min-h-screen bg-background pb-32">
      ...
      <main className="max-w-3xl mx-auto px-4 mt-8 flex flex-col gap-6">
        <div className="flex flex-col gap-4">
          {items.map((item) => (
            <div key={item.id} className="flex gap-4 p-4 bg-surface-container border surface-border rounded-2xl items-center relative group">
              ...
              <div className="flex-1 flex flex-col">
                <h3 className="font-semibold text-sm line-clamp-2 pr-8">{item.name}</h3>
                <p className="text-primary font-bold mt-1 text-sm">Rp {item.price.toLocaleString('id-ID')}</p>
        ...
        <div className="mt-4 p-6 bg-surface-container rounded-3xl border surface-border flex flex-col gap-4">
          <h3 className="font-bold text-lg border-b surface-border pb-3">Ringkasan Belanja</h3>
